...
function NetflixCreatorPage() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      categories: [
        { title: "Momentos Inesquecíveis", items: [] },
        { title: "Nossas Viagens", items: [] },
      ],
      contactName: "",
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
        const pageDataForDb = { ...data, plan: 'essencial' };
        ...
        <div className="container section-padding">
            <div className="max-w-4xl mx-auto">
                 <header className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground mt-2">Preencha os campos abaixo para criar a sua própria experiência de streaming romântica.</p>
                </header>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
                        ...
                        {/* Seção de Destaque */}
                        <div className="space-y-6 bg-card/10 p-6 rounded-lg">
                             ...
                             <FormField
                                ...
                                render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Nome do Perfil (no canto superior)</FormLabel>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Imagem de Capa Principal</FormLabel>
                                        <FormControl>
                        ...
                        <div className="space-y-8">
                             <h2 className="text-2xl font-bold border-b border-red-600 pb-2">Suas Categorias (Séries e Filmes)</h2>
                             {categories.map((category, categoryIndex) => (
                                <div key={category.id} className="space-y-4 bg-card/10 p-6 rounded-lg relative">
                                    <FormField
                                        control={form.control}
                                    ...
                                    />
                                    <ItemsFieldArray categoryIndex={categoryIndex} />
...
function ItemsFieldArray({ categoryIndex }: { categoryIndex: number }) {
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {fields.map((item, itemIndex) => (
          <div key={item.id} className="space-y-2 relative group">
            ...
            />
            {/* Poderiamos adicionar campos de titulo e descricao aqui se quisermos */}
