    ...
    <header className={cn(
      ...
      <div className="container flex items-center justify-between h-24">
        <Link href="/" className="flex items-center gap-2">
          <Image src="https://i.imgur.com/L4QSoTw.png" alt="Luv Logo" width={140} height={140} className="w-28 h-28 md:w-32 md:h-32" />
        </Link>
            ...
            <Sheet>
                ...
                <SheetContent side="left" className="w-full max-w-sm bg-background">
                     <div className="flex flex-col h-full p-4">
                        <div className="mb-8">
                             <Link href="/" className="flex items-center gap-2">
                                <Image src="https://i.imgur.com/L4QSoTw.png" alt="Luv Logo" width={140} height={140} className="w-32 h-32" />
                            </Link>
                        </div>
