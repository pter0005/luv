  ...
  return (
    <div className="grid w-full min-h-screen grid-cols-1 lg:grid-cols-2">
                                  ...
                                  <div className="absolute inset-0 w-full h-full">
                                      {opt.value === 'stars' ? (
                                          <div className="w-full h-full bg-black relative overflow-hidden"><StarsBackground/></div>
                                           ...
                                           <div className="w-full h-full bg-black relative overflow-hidden"><HeartsBackground color="purple" /></div>
                                      ) : opt.video ? (
      ...
      <div className="hidden lg:flex sticky top-0 items-center justify-center w-full h-screen p-8 bg-background">
         <div className="absolute inset-0 w-full h-full -z-10 overflow-hidden pointer-events-none purple-fog">
         </div>
